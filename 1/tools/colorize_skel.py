...
# source plates live in 1/data/ (gitignored); resolve relative to this file
# so the script runs from anywhere, e.g. `uv run 1/tools/colorize_skel.py`
DATA = Path(__file__).resolve().parent.parent / 'data'

# name of the input file
imname = str(DATA / 'cathedral.jpg')
